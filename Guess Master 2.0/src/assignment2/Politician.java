...
public class Politician extends Person {
    ...
    public Politician(Politician politician){
        super(politician);                                          //copying input object into new object
        party = politician.getParty();
    }

    //accessor to fetch party
    public String getParty() {
        return party;
    }

    public Politician clone() {
        return new Politician(this);                                //make a duplication of the input object
    }

    //returning a String for abstract method entityType
    public String entityType() {
        return "This is a Politician!";                             //entityType is Singer
    }
