...
public class GuessMaster {
    ...
    //welcomes player and displays the rules of the game 
    public void printRules() {
        System.out.println("================================================================\n");
        System.out.println("            Guess Master 2.0               ");
        System.out.println("Press the 'Enter' key when you are ready to start.");
        System.out.println("================================================================");
        System.out.print("\n");
    }
    ...
    //play game guessing for a specific entity given in the inputs of the function
    ...
    //new code using created classes
    public static void main(String[] args) {
        ...
        Person myCreator = new Person("My Creator", new Date("September", 1, 2000), "Female", 1.0);
