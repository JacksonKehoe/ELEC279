...
package assignment2;
//country class extension of entity
public class Country extends Entity {
    ...
    public Country(Country country) {
        super(country);                                             //copying input object into new object
        capital = country.getCapital();
    }

    //initialize clone
    public Country clone() {                                        //make a duplication of the input object
        return new Country(this);
    }

    //accessor to fetch capital
